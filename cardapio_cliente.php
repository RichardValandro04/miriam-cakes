...
<body>
                        ...
                        <?php
                            ...
                            ?>                    
                                <tr>
                                    ...
                                    <td class="td_info_doces">
                                        <div>
                                            <p class="nome_doce" data-id = <?php echo htmlspecialchars($linha['pk_id_doce']);?> ><?php echo htmlspecialchars($linha['nome_sabor']);?></p>
                                            <p class = "ingredientes_doce"><?php echo htmlspecialchars($linha['descricao']);?></p>
                                        </div>
                                    </td>
                                    <td class="td_info_valores">
                                        <div>
                                            <p class="valor_doce"  value = <?php echo htmlspecialchars($linha['valor_dezena']);?>>R$ <?php echo htmlspecialchars(number_format($linha['valor_dezena'], 2, ',', '.'));?></p>
                    ...
                    <table class="table_recheios">
                        ...
                        <?php   
                            ...
                            foreach ($recheios as $linha) {
                                ?>
                                <tr class="recheio">
                                    <td><input type="checkbox" name="recheio" class="checkbox_config" id = "nome_recheio" data-id=<?php echo htmlspecialchars($linha['pk_id_recheio']); ?> value = "<?php echo htmlspecialchars($linha['nome_recheio']); ?>"> <?php echo htmlspecialchars($linha['nome_recheio']); ?></td>
                                </tr>
                        <?php
                            }
                        }
                        ...
                        <?php   
                            ...
                            foreach ($bolos as $linha) {
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <p class="quantidade_fatias" id-tamanho = <?php echo htmlspecialchars($linha['pk_id_tamanho_bolo']); ?> data-id = <?php echo htmlspecialchars($linha['quantidade_fatias']); ?> ><?php echo htmlspecialchars($linha['quantidade_fatias']); ?> Fatias</p>
                                            <p class="barra"></p>
                                        </div>
                                    </td>
                                    <td>
                                        <div>
                                            <p class="valor_bolo" value = <?php echo htmlspecialchars($linha['valor']); ?>>R$ <?php echo htmlspecialchars(number_format($linha['valor'], 2, ',', '.')); ?></p>
                                            <p class="barra"></p>
                                        </div>
                                    </td>
    ...
    <footer>
        <button class="botao_pedido"> REALIZAR PEDIDO</button>
    </footer>
