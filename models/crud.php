...
*************************************************************/
	...
	abstract class CRUD extends Database{
		...
		***************/
		public function  find($id, $nomeColuna){
			$sql = "SELECT * FROM $this->table WHERE $nomeColuna = :id";
		...
		***************/
		public function delete($id, $nomeColuna){
			$sql="DELETE FROM $this->table WHERE $nomeColuna = :id";
			$stmt = Database::prepare($sql);	
